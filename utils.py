...
def plot_image(image, boxes, path):
    ...
    class_labels = config.A2D2_CLASSES
...
def save_checkpoint(model, optimizer, filename="Saved_model/my_checkpoint.pth.tar"):
...
def plot_couple_examples(model, loader, thresh, iou_thresh, anchors):
    ...
    #x, y = next(iter(loader))
        ...
        for i in range(y[0].shape[1]):
            ...
            print('gt')
            path= r"E:\Thesis_Final\Baseline\object_detection\YOLOv3\gt\image_{}.png".format(batch_idx)
        ...
        for i in range(batch_size):
            ...
            print('pred')
            path= r"E:\Thesis_Final\Baseline\object_detection\YOLOv3\pred\image_{}.png".format(batch_idx)
